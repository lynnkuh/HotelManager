...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self bootstrapApp];
    [Flurry startSession:@"TQ3CGNJ68JZVZFK6FC3F"];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.lynnkuhlman.HotelManager" in the application's documents directory.
